...
<html>
    ...
    <body>
        ...
        <section class="vh-100" style="background-color: #f4f5f7; ">
            ...
            <jsp:setProperty name="data" property="id" value="${requestScope.account.accountId}"></jsp:setProperty>
                            ...
                            <div class="card mb-3" style="border-radius: .5rem; height: 500px; padding: 20px; margin-top: 50px">
                                <div class="row g-0">
                                    <div class="col-md-4 gradient-custom text-center text-white"
                                        ...
                                        <img src="${requestScope.account.profile.img}"
                                         alt="Avatar" class="img-fluid my-4" style="width: 80px;" />
                                    <div class="text">
                                        <h5>${(String.valueOf(requestScope.account.profile.gender) == 'F') ? 'Miss' : 'Mr'} ${requestScope.account.profile.firstName} ${requestScope.account.profile.lastName} </h5>
                                        <p>@${requestScope.account.username}</p>
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row pt-1">
                                            <div class="col-6 mb-3">
                                                <h6>Email</h6>
                                                <p class="text-muted">${requestScope.account.email}</p>
                                            </div>
                                            <div class="col-6 mb-3">
                                                <h6>Phone</h6>
                                                <p class="text-muted">${requestScope.account.profile.phone}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row pt-1">
                                            <div class="col-6 mb-3">
                                                <h6>Date of Birth</h6>
                                                <p class="text-muted">${requestScope.account.profile.birthdate}</p>
                                            </div>
                                            <div class="col-6 mb-3">
                                                <h6>Year of Experiences</h6>
                                                <p class="text-muted">${requestScope.account.profile.yearExp} years</p>
                                            </div>
                                        </div>
                                        <h6>Education</h6>
                                        <hr class="mt-0 mb-3">
