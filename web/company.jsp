...
<html>
    ...
    <body>
        <jsp:include page="includes/header.html"></jsp:include>
            <!-- Page Content -->
            <header class="">
                <nav class="navbar navbar-expand-lg" style="background-color: #0007;">
                    <div class="container">
            ...
            <div class="container d-flex">
                <div>
                    ...
                    <div class="caption mt-3">
                        <h3 class="title">Explore 100,000+ featured companies</h3>
                ...
                <div class="row">
                    <c:forEach items="${companyList}" var="cl"> 
                        <form action="company" method="get">
                            <div class="col-md-4 col-sm-6 p-2 mb-5">
                                <div class="card1" style="height: 400px">
                                    ...
                                    <div class="content1">
                                        ...
                                        <div class="blog-preview__bottom1">
                                            <div class="blog-author1">
                                                <img src="assets/images/profile_small.png" alt="Avatar">
