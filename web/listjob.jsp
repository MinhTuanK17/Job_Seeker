                ...
                <div class="row">               
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <jsp:setProperty property="applierId" name="jobData" value="${sessionScope.account.accountId}"></jsp:setProperty>

                            <c:forEach items="${jobData.jobByApplierId}" var="j">
                                <jsp:setProperty property="jobId" name="jobData" value="${j.id}"></jsp:setProperty>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="down-content">
                                            ...
                                            <a href="${jobData.CV}" class="filled-button">View CV</a>
